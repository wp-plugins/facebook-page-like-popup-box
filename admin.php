 ...
 */
	...
	public function add_menus(){
		...
		if (isset($o['submenu']) && $o['submenu']==1){
	      	add_submenu_page('options-general.php','Facebook Page Like Popup Box', 'Facebook Popup Box Settings', 'manage_options', 'arvlb-tld', array($this,'render_page'));
		} else{
	      	add_menu_page('Facebook Page Like Popup Box', 'Facebook Popup Box Settings', 'manage_options', 'arvlb-tld', array($this,'render_page'));
	      }
	}
	/**
